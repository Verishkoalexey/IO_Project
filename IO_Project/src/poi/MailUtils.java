    ...
    public static void send(String from, String to, String filename) {
         // Recipient's email ID needs to be mentioned.
          ...
          try {
             ...
             messageBodyPart.setText("<b>This</b> <p>is message body. Check this - " + link);
...
//           message.setContent(email.getBody(), "text/html; charset=ISO-8859-1");
    ...
    static void send (String from, String to, String filename, String htmlContent, String subject){
        AppSettings settings = AppSettings.getInstance();
          ...
          Session session = Session.getInstance(settings.getProps(),
              new Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication(username, password);
                }
